...
def getEnergyConfig(X):
    ...
    # E, energyPerParticle = ha.get3DPotNearFirstNeighb(X, V)
...
def mc_move(i, E_old, X_old, Xeq, forceMatrix, E_m_minus_1, E_m_minus_2, L):
    import copy
    import harmonic as ha
...
def randomMCmoves(Eminimo, E_mMinus2, E_mMinus1, E_m,\
                  nSteps, e, X, log_idos, log_sum_idos, L, Xeq, forceMatrix):
    import copy
    import harmonic as ha
    ...
    while( (not belongs(ratioAcceptances, ratioMin, ratioMax) and\
        ...
        for i in range(nSteps):
            ...
            e, X, hasMoved = mc_move(i, e, X, Xeq, forceMatrix, E_mMinus1, E_mMinus2, L)
